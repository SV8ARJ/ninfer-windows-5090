...
int main() {
    ...
    const ninfer::ModelSamplingDefaults qwen3_8_uncensored =
        Dense27::sampling_defaults(Dense27::qwen3_8_uncensored_model_id);
    ...
    failures += check(same_preset(qwen3_8_uncensored.thinking, dense_thinking) &&
                           same_preset(qwen3_8_uncensored.non_thinking, dense_non_thinking),
                       "Qwen3.8-27B uncensored defaults mismatch");
